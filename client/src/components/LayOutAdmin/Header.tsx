...
<header className=''>
  <div className="pt-2 relative mx-auto text-gray-600 flex justify-end items-center mt-[17px]">
    ...
    <button type="submit" className="absolute right-24 top-[-28px] mt-5 mr-4">
    ...
    <div className="px-3">
      <i className="fa-solid fa-user fa-lg" style={{color: '#ffffff'}} />
    </div>
    <div className="px-3">
      <i className="fa-solid fa-bell fa-lg" style={{color: '#ffffff'}} />
    </div>
  </div>
</header>
